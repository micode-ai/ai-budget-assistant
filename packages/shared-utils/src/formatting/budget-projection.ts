 ...
 *
 * Mirror of the canonical copy at
 * `apps/api/src/common/utils/budget-projection.ts`. This is the one the mobile
 * store imports. Same convention and same reason as `financial-month.ts`
