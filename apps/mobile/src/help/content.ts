...
Формула: **Поточний баланс = Початковий баланс - Загальні витрати + Загальний дохід + Отримано обміном - Обміняно**
...
Formula: **Biezace saldo = Saldo poczatkowe - Lacznie wydano + Laczne przychody + Otrzymano z wymiany - Wymieniono**
...
- **P: Czy wymiana walut liczy sie jako wydatek?**
  **O:** Nie. Wymiany walut sa oddzielone od wydatkow -- przenoszae pieniadze miedzy portfelami walutowymi bez wplywu na sumy wydatkow.
...
La formule : **Solde actuel = Solde initial - Total depense + Total des revenus + Change entrant - Change sortant**
