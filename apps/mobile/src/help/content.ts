...
*See also: Accounts | Subscription Plans | Export & Reports*
`,
    },
    {
      id: '12-subscription',
...
*См. также: Счета | Тарифные планы | Экспорт и отчёты*
`,
    },
    {
      id: '12-subscription',
...
4. После готовности отчёт появится в списке Недавние отчёты ниже
5. Нажмите на отчёт, чтобы скачать и поделиться им
...
- Размера файла
- Нажмите для скачивания и отправки через системное меню «Поделиться»
...
*Див. також: Рахунки | Тарифні плани | Експорт і звіти*
`,
    },
    {
      id: '12-subscription',
...
*Zobacz takze: Konta | Plany subskrypcji | Eksport i raporty*
`,
    },
    {
      id: '12-subscription',
...
*Siehe auch: Konten | Abonnement-Plane | Export & Berichte*
`,
    },
    {
      id: '12-subscription',
...
*Ver tambien: Cuentas | Planes de suscripcion | Exportacion e informes*
`,
    },
    {
      id: '12-subscription',
...
*Voir aussi : Comptes | Abonnement | Export et rapports*
`,
    },
    {
      id: '12-subscription',
...
*Гл. таксама: Рахункі | Тарыфныя планы | Экспарт і справаздачы*
`,
    },
    {
      id: '12-subscription',
