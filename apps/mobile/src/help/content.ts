...
6. Выберите предпочтительную **Валюту** (USD, EUR, PLN, GBP, UAH или RUB)
7. Выберите предпочтительный **Язык** (English, Deutsch, Espanol, Francais, Polski, Русский или Українська)
...
3. Нажмите на символ валюты, чтобы сменить валюту (USD, EUR, PLN, GBP, UAH, RUB)
4. Введите **сумму**
...
- **В: Можно ли добавлять расходы в разных валютах?**
  **О:** Да! Нажмите на символ валюты в форме расхода, чтобы переключиться между USD, EUR, PLN, GBP, UAH и RUB.
...
Выберите один из 7 поддерживаемых языков:
...
- **Неограниченные валюты** — используйте все 6 валют без ограничений
...
- **Мультивалютний гаманець** — відстежуйте баланси в USD, EUR, PLN, GBP, UAH та RUB з актуальними курсами обміну
...
- **7 мов** — English, Deutsch, Espanol, Francais, Polski, Русский, Українська
...
6. Оберіть **Валюта** (USD, EUR, PLN, GBP, UAH або RUB)
7. Оберіть **Мова** (English, Deutsch, Espanol, Francais, Polski, Русский або Українська)
...
- **П:** Які мови підтримує голосовий ввід?
  **В:** Голосовий ввід найкраще працює мовою, на яку налаштовано ваш додаток. Підтримуються всі 7 мов додатку.
...
2. Оберіть **Валюта** (USD, EUR, PLN, GBP, UAH або RUB)
...
- **Необмежені валюти** — використовуйте всі 6 валют без обмежень
