// Native crypto implementation using expo-crypto and tweetnacl
// No dependency on crypto.subtle — works on all Hermes versions
...
// Configure tweetnacl PRNG to use expo-crypto (Hermes lacks crypto.getRandomValues)
...
// --- Pure JS SHA-256 (avoids native bridge overhead for PBKDF2 loop) ---
...
// Public async wrapper (for API compatibility)
...
// --- PBKDF2-HMAC-SHA256 (pure JS, synchronous inner loop) ---
...
// Named encryptAesGcm/decryptAesGcm for API compatibility with crypto.web.ts
