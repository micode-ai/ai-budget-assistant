...
export const aiApi = {
  ...
  /** Read-only suggestions for this account's uncategorized incomes. */
  categorizeUncategorizedIncome() {
    return httpClient.request<CategorizeIncomeSuggestionsResponse>('/ai/categorize-uncategorized-income', {
      method: 'POST',
      body: JSON.stringify({}),
    });
  },
