export default {
  ...
  expenses: {
    ...
    merge: {
      ...
      survivorQuestion: '¿Qué registro conservar?',
      keep: 'Conservando',
      keepFields: 'Campos a conservar del otro registro',
      fieldMerchant: 'Comerciante',
      fieldNotes: 'Notas',
      fieldCategory: 'Categoría',
      fieldProject: 'Proyecto',
      fieldTags: 'Etiquetas',
      fieldReceipt: 'Imagen del recibo',
      confirm: 'Combinar',
      merged: 'Gastos combinados correctamente.',
      cannotMergeSelf: 'No se puede combinar un gasto consigo mismo.',
      currencyNote: 'El registro superviviente conserva su propia moneda e importe. Solo queda un registro.',
    },
  },
  categorize: {
    ...
    titleIncome: 'Categorizar ingresos',
    analyzing: 'Analizando gastos…',
    analyzingIncome: 'Analizando ingresos…',
    ...
    skippedEncryptedIncome: 'Ingresos cifrados omitidos: {{count}}',
  ...
  expensesDesktop: {
    ...
    colAccount: 'Agregado por',
    colAmount: 'Monto',
    summaryCount: 'Transacciones',
    moreCurrencies_one: '+{{count}} moneda más',
    moreCurrencies_other: '+{{count}} monedas más',
    emptyState: 'Todavía no hay transacciones',
    facetsHeading: 'Filtros',
    clearAllFilters: 'Borrar todo',
    facetPeriod: 'Periodo',
    facetKind: 'Mostrar',
    facetCategory: 'Categoría',
    facetMerchant: 'Comercio',
    kindAll: 'Todos',
    noMerchant: 'Sin comercio',
    clearFacet: 'Borrar',
    noOptions: 'Sin resultados para los filtros actuales',
    showMore: '+{{count}} más',
    showLess: 'Mostrar menos',
    filtersLabel: 'Filtros ({{count}})',
    dialogClose: 'Cerrar',
    discardChangesTitle: '¿Descartar los cambios?',
    discardChangesMessage: 'Tienes cambios sin guardar. Si cierras ahora, se perderán.',
    discardChangesConfirm: 'Descartar',
    selectRow: 'Seleccionar fila',
    selectAllRows: 'Seleccionar todas las filas visibles',
  ...
  analytics: {
    ...
    totalDepositsPaid: 'Depósitos pagados',
    totalDepositsPaidText: 'Pagaste {{amount}} en depósitos de envases retornables este {{range}}.',
    savingsDetailDiscountTitle: 'Ahorros por descuento',
    savingsDetailDepositTitle: 'Depósitos pagados',
    savingsDetailByStore: 'Por tienda',
    savingsDetailRecent: 'Recibos recientes',
    savingsDetailEncrypted: 'Esta cuenta está totalmente cifrada, así que no podemos desglosarlo.',
    savingsDetailEmpty: 'Aún no hay nada registrado para este período.',
    savingsDetailApprox: 'Algunos importes usan un tipo de cambio aproximado.',
    savingsDetailDiscountNote: 'Descuentos ya aplicados en tus recibos — no es una promesa sobre futuras ofertas.',
    savingsDetailDepositNote: 'Lo que pagaste en caja por envases retornables — no es un reembolso; los envases devueltos no se registran.',
  ...
  chat: {
    ...
    actionAddShoppingList: 'Añadido a la lista de la compra',
    actionRemoveShoppingList: 'Eliminado de la lista de la compra',
    actionShoppingNotFound: 'No encontrado: {{names}}',
    actionShoppingSuggestions: 'Sugerencias de compra',
  ...
  expenseDetail: {
    ...
    sourceNotification: 'Captura automática',
    extractItems: 'Extraer artículos',
    extractingItems: 'Leyendo el recibo…',
    extractItemsTitle: 'Reemplazar artículos',
    extractItemsConfirm: 'Este gasto ya tiene {{count}} artículo(s). ¿Reemplazarlos por las líneas leídas del recibo?',
    extractItemsNoItems: 'No se encontraron artículos en este recibo.',
    extractItemsDone: '{{count}} artículo(s) extraídos del recibo.',
    extractItemsFailed: 'No se pudo leer el recibo. Inténtalo de nuevo.',
  ...
  dashboardDesktop: {
    ...
    focusEmptyBody: 'Activa {{safeToSpend}}, {{netProfit}}, {{incomeExpenses}}, {{monthlyBudget}} o {{wallets}} para verlo aquí.',
  ...
  accounts: {
    ...
    financialMonthStartsOn: 'El mes comienza el día {{day}}',
    financialMonthCalendar: 'Mes calendario (día 1)',
    financialMonthPickerTitle: 'El mes financiero comienza el',
    financialMonthHint:
      'Si tu salario llega el día 10, elige 10 — los presupuestos e informes irán del 10 al 9. Los períodos pasados también se reagrupan; no se modifica ningún dato.',
    financialMonthClamped: 'En los meses más cortos, el período comienza el último día.',
  },
  settings: {
    title: 'Ajustes',
    profile: 'Perfil',
    ...
    paymentConsequenceHint: 'Revolut y PayPal añaden un botón de pago real a tus enlaces de reparto; BLIK muestra tu número con instrucciones en su lugar (sin enlace entre bancos); Efectivo y Otro muestran lo que escribes como instrucciones en lugar de un botón.',
  ...
  alerts: {
    ...
    mergeTitle: '¿Misma compra, dos monedas?',
    mergeBody: '{{amountA}} {{currencyA}} y {{amountB}} {{currencyB}} en {{merchant}} parecen la misma transacción. ¿Combinarlos?',
    alreadyResolvedTitle: 'Ya resuelto',
    alreadyResolvedBody: 'Parece que ya se resolvió: ese gasto ya no está aquí.',
    tabAlerts: 'Alertas',
    tabInvitations: 'Invitaciones',
    invitationTitle: 'Invitación para unirte a {{accountName}}',
  ...
  bankImport: {
    ...
    possibleMerge: 'Puede existir ya en otra moneda',
    mergeWithExisting: 'Combinar con existente',
    importAsNew: 'Importar como nuevo',
    aiConsentTitle: '¿Dejar que la IA lea este extracto?',
    aiConsentBody:
      'No reconocemos el formato de este banco. La IA puede averiguar qué columna es la fecha, el importe y la descripción; luego tu dispositivo hace el resto.',
    aiConsentWhatLeaves: 'Qué se envía',
    aiConsentWhatLeavesCsv: 'La fila de encabezado y hasta 10 filas de ejemplo de tu archivo.',
    aiConsentWhatLeavesPdf: 'Las primeras 20 líneas de texto de tu extracto.',
    aiConsentThirdParty: 'Estos datos se envían a un proveedor de IA externo para su análisis y no se conservan para entrenar modelos.',
    aiConsentOnce: 'Se pregunta una vez por cuenta. Aún puedes asignar las columnas tú mismo.',
    aiConsentAccept: 'Usar IA',
    aiConsentDecline: 'Lo asignaré yo mismo',
    aiConsentFailed: 'No se pudo guardar tu elección. Inténtalo de nuevo.',
    aiInferredBy: 'Columnas identificadas por IA',
    aiInferredEdit: '¿Incorrecto? Toca para corregir',
    aiCurrencyAssumed: 'Este archivo no tiene columna de moneda, así que cada fila se leyó como {{currency}}. Compruébalo antes de importar.',
    aiWarningNoBalance: 'No pudimos verificar que se encontraran todas las transacciones: este extracto no tiene saldo final con el que comparar. Revisa la lista.',
    aiWarningMismatch: 'Las transacciones encontradas no coinciden con el saldo final de este extracto. Puede que falten algunas filas.',
    aiWarningTruncated: 'Este extracto era demasiado largo para leerlo por completo: {{count}} página(s) no se procesaron.',
    aiPdfPaywall: 'Leer extractos en PDF con IA',
    aiBankGuess: 'Parece ser: {{bank}}',
    aiCurrencyFix: 'Cambiar moneda',
    aiRoleDate: 'Fecha',
    aiRoleAmount: 'Importe',
    aiRoleDebit: 'Cargo',
    aiRoleCredit: 'Abono',
    aiRoleDescription: 'Descripción',
    aiRoleCurrency: 'Moneda',
    aiRoleCounterparty: 'Beneficiario',
    error: {
  ...
  exchange: {
    ...
    rateAlerts: 'Alertas de tipo de cambio',
    notifyMe: 'Avísame cuando el tipo de cambio alcance mi objetivo',
    targetRate: 'Tipo de cambio objetivo',
    above: 'por encima de',
    below: 'por debajo de',
    addAlert: 'Añadir alerta',
    alertCreated: 'Alerta creada — te avisaremos cuando se alcance el tipo de cambio.',
    deleteAlertConfirm: '¿Eliminar esta alerta de tipo de cambio?',
    noAlerts: 'Aún no hay alertas para este par.',
    alertWhen: 'Avisar cuando {{direction}} {{rate}} {{toCurrency}}',
    newAlert: 'Nueva alerta',
    alertsWaiting: 'En espera',
    alertsFired: 'Ya activadas',
    noAlertsYet: 'Aún no tienes alertas. Fija un objetivo y te avisaremos cuando el tipo de cambio lo alcance.',
    alertFiredAt: 'Activada en {{rate}} · {{date}}',
  ...
  onboarding: {
    ...
    bringHistoryHint: 'Desde tu banco u otra app de presupuesto',
  ...
  purchaseRequests: {
    ...
    deleteConfirm: 'La solicitud se eliminará permanentemente',
  },
  splits: {
  ...
  trip: {
    ...
    splitPercentage: 'Porcentaje',
    splitShares: 'Partes',
    splitSelectMember: 'Selecciona al menos un miembro',
    splitExactMismatch: 'Los importes deben sumar {{amount}}',
    splitPercentageMismatch: 'Los porcentajes deben sumar 100 %',
    createTrip: 'Crear viaje',
    tripName: 'Nombre del viaje',
    tripNamePlaceholder: 'p. ej. Verano en Italia',
    nameRequired: 'Introduce un nombre para el viaje',
    endDate: 'Fecha de fin',
    currency: 'Moneda',
    settleUp: 'Liquidar',
    balances: 'Saldos',
    ...
    allSettledHint: 'Todos en este viaje están al día — no se necesitan pagos.',
    payVia: 'Pagar',
    manualBlikInstructions: 'Envía este pago manualmente a:',
    markAsPaid: 'Marcar como pagado',
    markAsPaidBody: 'Avisa a la otra persona de que has enviado el pago. Lo confirmará al recibirlo.',
    ...
    paymentHandleBlikHint: 'Introduce tu número de teléfono en formato internacional, p. ej. +48 XXX XXX XXX.',
    paymentInfoSaved: 'Tu información de pago se ha guardado.',
    daysLeft: 'Quedan {{count}} días',
    daysLeft_one: 'Queda {{count}} día',
    tripEnded: 'Viaje finalizado — liquidar cuentas',
  ...
  reports: {
    ...
    thisYear: 'Este año',
    specificMonth: 'Mes concreto',
    customRange: 'Rango personalizado',
    selectMonth: 'Elige un mes',
    selectMonthHint: 'Elige un mes arriba',
    from: 'Desde',
    to: 'Hasta',
    pickDate: 'Elegir fecha',
    rangeIncomplete: 'Elige la fecha de inicio y de fin — el inicio no puede ser posterior al fin',
    monthlyDigestIndependent: 'Mes actual, independiente del rango de arriba',
    generate: 'Generar',
  ...
  map: {
    mapView: 'Mapa',
    listView: 'Lista',
    noLocationCount_one: '{{count}} gasto sin ubicación',
    noLocationCount_other: '{{count}} gastos sin ubicación',
    open: 'Abrir',
  },
  debt: {
  ...
  referral: {
    ...
    inviteCardTitle: 'Los dos salís ganando',
    inviteCardBody: "Tu amigo acaba de devolverte el dinero por la app. Envíale una invitación: él consigue una prueba más larga y tú peticiones de IA extra.",
    inviteCardAction: 'Invitarle',
  ...
  wrapped: {
    ...
    notEnoughData: 'Todavía no hay suficientes datos',
    notEnoughDataDesc: 'Registra tus gastos e ingresos durante el año para desbloquear tu resumen anual.',
    swipeHint: 'Desliza para continuar →',
    introTitle: 'Tu {{year}}\nen números',
    introSub: 'Repasemos tu año',
    totalTracked: 'Registraste',
    spentLabel: 'gastado este año',
    earnedLabel: 'Ingresado',
    transactions: 'Transacciones',
    topMerchant: 'Tu lugar favorito',
    merchantVisits: '{{count}} visitas',
    merchantSpent: '{{value}} en total',
    biggestMonth: 'Tu mes más grande',
    topCategory: 'Categoría principal',
    ofSpending: '{{percent}}% del gasto',
    categoryMix: 'A dónde fue',
    receiptsScanned: 'Recibos escaneados',
    receiptsScannedDesc: 'Cada escaneo afina más tus estadísticas',
    saved: 'Ahorraste',
    overspent: 'Gastaste más de lo que ingresaste',
    savingsRate: '{{percent}}% de ahorro',
    savedVsLastYear: '{{direction}} {{value}} frente al año pasado',
    personalInflation: 'Tu inflación personal',
    inflationDesc: 'Cómo cambiaron tus propios precios este año',
    streakDays: '{{count}} días',
    longestStreak: 'Racha de seguimiento más larga',
    outroTitle: '¡Ese fue tu {{year}}!',
    outroDesc: 'Comparte tu año en números',
    hideAmounts: 'Ocultar cantidades',
    share: 'Compartir',
    shareTitle: '🎁 Mi resumen {{year}} — AI Budget',
    shareSpent: 'Registré {{value}} en gastos',
    shareMerchant: 'Lugar favorito: {{name}} ({{count}} visitas)',
    shareMonth: 'Mes más grande: {{month}}',
    shareCategory: 'Categoría principal: {{name}} ({{percent}}%)',
    shareReceipts: 'Recibos escaneados: {{count}}',
    shareSaved: 'Ahorrado: {{value}}',
    shareInflation: 'Mi inflación personal: {{percent}}%',
    shareStreak: 'Racha más larga: {{count}} días',
    shareCta: 'Registra la tuya → ai-budget.pl',
  },
  communityPrices: {
    sectionTitle: 'Precios de la comunidad',
    contributeToggle: 'Compartir precios anónimos',
    contributeToggleDesc: 'Contribuye con precios de productos anonimizados de tus recibos para ayudar a todos a encontrar la tienda más barata. No se comparten datos personales.',
    screenTitle: 'Dónde es más barato',
    entryTitle: '¿Dónde es más barato?',
    entrySubtitle: 'Compara precios de la comunidad entre tiendas',
    searchPlaceholder: 'Buscar un producto...',
    searchHint: 'Busca un producto para comparar precios entre tiendas',
    noResults: 'Aún no hay precios de la comunidad para este producto',
    regionsAvailable: '{{count}} regiones',
    cheapest: 'Más barato',
  ...
  safeToSpend: {
    title: 'Gasto seguro',
    today: 'Gasto seguro hoy',
    subtitle: 'Después de cubrir tus obligaciones',
    breakdownTitle: 'Cómo se calcula',
    wallet: 'Saldo en cartera',
    expectedIncome: 'Ingresos esperados',
    subscriptions: 'Suscripciones próximas',
    recurring: 'Gastos recurrentes próximos',
    goals: 'Aportaciones a metas',
  ...
  inflationShield: {
    ...
    estimated: 'estimado',
    basketForecast: 'Tu cesta: ~{{pct}}% el próximo mes',
    buyAheadTitle: 'Compra antes y ahorra',
    buyAheadTip: 'Compra {{product}} ahora — ahorra ~{{save}}',
    units: '{{count}} unidad',
    units_other: '{{count}} unidades',
    atStore: 'en {{store}}',
    affordable: 'Asequible hoy',
    approxRate: 'Los importes usan tasas de cambio aproximadas',
    empty: 'Nada que abastecer por ahora',
    emptySub: 'Escanea algunos recibos para que podamos detectar precios en alza para ti',
    share: 'Compartir',
    hideAmounts: 'Ocultar importes',
    shareTitle: '🛡️ Mi Escudo contra la inflación — AI Budget',
    shareSaved: 'Ahorrado hasta ahora: ~{{value}}',
    shareBasket: 'Previsión de mi cesta: +{{pct}}%/mes',
    shareItem: '{{product}} sube +{{pct}}% — ahorra ~{{save}} comprando antes',
    shareTotal: 'Podrías ahorrar ~{{value}} comprando por adelantado',
    shareCta: 'Vence a la inflación → ai-budget.pl',
  },
  affordability: {
    yes: 'Sí, asequible',
    no: 'No es asequible ahora',
  ...
  priceHistory: {
    ...
    noDataForPeriod: 'No hay suficiente historial para este período. Prueba un rango más corto.',
    ...
    removePrice: 'Eliminar este precio',
    removePriceConfirm: '¿Eliminar el precio del {{date}} ({{price}})? Útil para descuentos únicos que distorsionarían tu índice de inflación.',
  ...
  shoppingList: {
    ...
    settingsSubtitle: 'Planifica tu compra, encuentra la tienda más barata',
    planAShop: 'Planificar una compra',
    addItem: 'Añadir artículo',
    addFreeText: 'Añadir "{{text}}"',
    frequentlyBought: 'Comprados con frecuencia',
    searchProducts: 'Buscar productos',
    emptyList: 'Añade tu primer artículo',
    noLists: 'Aún no hay listas de la compra',
    createFirstList: 'Crear una lista',
    clearChecked: 'Borrar marcados',
    compareCta: 'Comparar precios',
    compareTitle: 'Dónde es más barato',
    comparePaywall: 'Comparar precios de la cesta entre tiendas es una función Pro.',
    cheapest: 'Más barato',
    coverage: '{{covered}}/{{total}} artículos',
    stalePrices: 'Algunos precios están desactualizados',
    missingCount: '{{count}} sin precio aquí',
    cheapestPerItem: 'Precio más bajo por artículo',
    notTracked: 'Aún sin seguimiento',
    noPriceData: 'Todavía no hay historial de precios — escanea algunos recibos primero',
    ...
    archiveListConfirm: '¿Archivar esta lista? Se ocultará pero no se eliminará.',
    listName: 'Nombre de la lista',
    manageLists: 'Gestionar listas',
    quantity: 'Cantidad',
    restockTitle: 'Hora de reponer',
    mapTitle: 'Mapa de tiendas',
    ...
    saveAsTemplate: 'Guardar lista actual como plantilla',
    templateNamePlaceholder: 'Nombre de la plantilla',
    noTemplates: 'Todavía no hay plantillas guardadas',
    templateItemCount: '{{count}} artículos',
    templateApplied: 'Plantilla aplicada',
    templateAllAlreadyOnList: 'Todo lo de esta plantilla ya está en tu lista',
    templateAppliedSomeSkipped: 'Añadidos {{added}}, {{skipped}} ya estaban en la lista',
  ...
  receiptSplit: {
    ...
    personName: 'Nombre',
    yourShare: 'Tu parte',
    shareByAmount: 'Importe',
    shareReset: 'A partes iguales',
    shareYou: 'Yo',
    shareOverAllocated: 'Las partes de esta línea superan el 100%',
    assignEveryone: 'Asigna al menos un artículo a cada persona',
    assignHint: 'Toca un artículo y luego marca a todos los que lo compartieron',
    tapPersonHint: 'Marca a todos los que compartieron este artículo',
    chipItemCount_one: '{{count}} artículo',
    chipItemCount_other: '{{count}} artículos',
    ...
    createSplit: 'Crear enlaces',
    shareWith: 'Enviar a {{name}}',
    copyAll: 'Copiar todos los enlaces',
    statusSent: 'Enviado',
    statusOpened: 'Abierto',
    statusClaimed: 'Dice que pagó',
    statusSettled: 'Saldado',
    confirmPaid: 'Confirmar recepción',
    confirmedToast: 'Marcado como saldado',
    cancelSplit: 'Cancelar división',
    cancelConfirm: '¿Cancelar esta división? Los enlaces dejarán de funcionar y las deudas se eliminarán.',
    tooMany: 'Puedes dividir con hasta 20 personas.',
  ...
  shortcuts: {
    ...
    searchFocus: 'Enfocar la búsqueda',
    newExpense: 'Nuevo gasto',
    navigateRows: 'Moverse entre filas',
    openRow: 'Abrir fila',
