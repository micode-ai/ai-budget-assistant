export default {
  ...
  expenses: {
    ...
    merge: {
      ...
      survivorQuestion: 'Keep which record?',
      keep: 'Keeping',
      keepFields: 'Fields to keep from other record',
      ...
      confirm: 'Merge',
      merged: 'Expenses merged successfully.',
      cannotMergeSelf: 'Cannot merge an expense with itself.',
      currencyNote: 'The survivor keeps its own currency and amount. Only one record remains.',
    },
  },
  categorize: {
    ...
    titleIncome: 'Categorize incomes',
    analyzing: 'Analyzing expenses…',
    analyzingIncome: 'Analyzing incomes…',
    ...
    skippedEncryptedIncome: 'Encrypted incomes skipped: {{count}}',
  ...
  expensesDesktop: {
    ...
    facetMerchant: 'Merchant',
    kindAll: 'All',
    noMerchant: 'No merchant',
    clearFacet: 'Clear',
    noOptions: 'No matches for the current filters',
    showMore: '+{{count}} more',
    showLess: 'Show less',
    filtersLabel: 'Filters ({{count}})',
    dialogClose: 'Close',
    discardChangesTitle: 'Discard changes?',
    discardChangesMessage: 'You have unsaved edits. Closing now will discard them.',
  ...
  analytics: {
    ...
    totalDepositsPaid: 'Deposits Paid',
    totalDepositsPaidText: 'You paid {{amount}} in returnable-packaging deposits this {{range}}.',
    savingsDetailDiscountTitle: 'Discount savings',
    savingsDetailDepositTitle: 'Deposits paid',
    savingsDetailByStore: 'By store',
    savingsDetailRecent: 'Recent receipts',
    savingsDetailEncrypted: "This account is fully encrypted, so we can't break this down.",
    savingsDetailEmpty: 'Nothing recorded yet for this period.',
    savingsDetailApprox: 'Some amounts use an approximate exchange rate.',
    savingsDetailDiscountNote: 'Discounts already applied on your receipts — not a promise about future deals.',
    savingsDetailDepositNote: "What you paid at checkout for returnable packaging — not a refund; returned bottles and cans aren't tracked.",
  ...
  chat: {
    ...
    actionAddShoppingList: 'Added to shopping list',
    actionRemoveShoppingList: 'Removed from shopping list',
    actionShoppingNotFound: 'Not found: {{names}}',
    actionShoppingSuggestions: 'Shopping suggestions',
  ...
  expenseDetail: {
    ...
    sourceNotification: 'Auto-captured',
    extractItems: 'Extract items',
    extractingItems: 'Reading receipt…',
    extractItemsTitle: 'Replace receipt items',
    extractItemsConfirm: 'This expense already has {{count}} item(s). Replace them with the lines read from the receipt?',
    extractItemsNoItems: 'No line items were found on this receipt.',
    extractItemsDone: '{{count}} item(s) extracted from the receipt.',
    extractItemsFailed: 'Could not read the receipt. Please try again.',
  ...
  budgetsDesktop: {
    summaryTotal: 'Total Budgets',
    needsAttention: 'Needs Attention',
    categoriesOverAllocation: 'Categories Over Allocation',
    needsAttentionHeading: 'Needs attention ({{count}})',
    onTrackHeading: 'On track ({{count}})',
    nearingLimit: 'Nearing limit',
    exceedsBy: 'Exceeds by {{amount}}',
  ...
  settings: {
    ...
    paymentConsequenceHint: 'Revolut and PayPal add a real pay button to your split links; BLIK shows your number with instructions instead (no cross-bank link); Cash and Other show what you enter as instructions instead of a button.',
  ...
  alerts: {
    ...
    alreadyResolvedBody: 'This looks like it was already handled — that expense is no longer here.',
    tabAlerts: 'Alerts',
    tabInvitations: 'Invitations',
    invitationTitle: 'Invitation to join {{accountName}}',
  ...
  bankImport: {
    ...
    possibleMerge: 'May already exist in another currency',
    mergeWithExisting: 'Merge with existing',
    importAsNew: 'Import as new',
    aiConsentTitle: 'Let AI read this statement?',
    aiConsentBody:
      "We don't recognize this bank's format. AI can work out which column is the date, the amount and the description — then your device does the rest.",
    ...
    aiConsentThirdParty: "It's sent to a third-party AI provider for analysis and isn't stored by them for training.",
  ...
  exchange: {
    ...
    notifyMe: 'Notify me when the rate hits my target',
    targetRate: 'Target rate',
    above: 'above',
    below: 'below',
    addAlert: 'Add alert',
    alertCreated: 'Alert created — we\'ll notify you when the rate is hit.',
    deleteAlertConfirm: 'Delete this rate alert?',
    noAlerts: 'No alerts for this pair yet.',
    alertWhen: 'Notify when {{direction}} {{rate}} {{toCurrency}}',
    newAlert: 'New alert',
    alertsWaiting: 'Waiting',
    alertsFired: 'Already fired',
    noAlertsYet: 'No rate alerts yet. Set a target and we\'ll notify you when the rate reaches it.',
    alertFiredAt: 'Fired at {{rate}} · {{date}}',
  ...
  // Placeholder keys for TripExpenseSplitPicker (ABA group-trip-wallet, Task 24),
  // the create-trip screen (Task 25), and the settle-up screen (Task 26).
  // Task 32 replaces/expands this namespace across all 9 locales.
  trip: {
    ...
    splitShares: 'Shares',
    splitSelectMember: 'Select at least one member',
    splitExactMismatch: 'Amounts must add up to {{amount}}',
    splitPercentageMismatch: 'Percentages must add up to 100%',
    ...
    allSettledHint: 'Everyone in this trip is even — no payments needed.',
    payVia: 'Pay',
    manualBlikInstructions: 'Send this payment manually to:',
    markAsPaid: 'Mark as Paid',
    markAsPaidBody: 'Let the other person know you’ve sent the payment. They’ll confirm once received.',
    ...
    paymentHandleBlikHint: 'Enter your phone number in international format, e.g. +48 XXX XXX XXX.',
    paymentInfoSaved: 'Your payment info has been saved.',
  ...
  reports: {
    ...
    selectMonthHint: 'Pick a month above',
    from: 'From',
    to: 'To',
    pickDate: 'Pick a date',
    rangeIncomplete: 'Pick a start and end date — the start cannot be after the end',
    monthlyDigestIndependent: 'Current month, independent of the range above',
    generate: 'Generate',
  ...
  referral: {
    ...
    inviteCardTitle: 'Both of you can get more',
    inviteCardBody: "Your friend just paid you back through the app. Send them an invite: they get a longer trial, you get bonus AI requests.",
    inviteCardAction: 'Invite them',
  ...
  wrapped: {
    ...
    notEnoughDataDesc: 'Track expenses and income through the year to unlock your Wrapped.',
    swipeHint: 'Swipe to continue →',
    introTitle: 'Your {{year}}\nin money',
    introSub: "Let's look back at your year",
    totalTracked: 'You tracked',
    spentLabel: 'spent this year',
    earnedLabel: 'Earned',
    transactions: 'Transactions',
    topMerchant: 'Your top spot',
    merchantVisits: '{{count}} visits',
    merchantSpent: '{{value}} in total',
    biggestMonth: 'Your biggest month',
    topCategory: 'Top category',
    ofSpending: '{{percent}}% of spending',
    categoryMix: 'Where it went',
    receiptsScanned: 'Receipts scanned',
    receiptsScannedDesc: 'Every scan makes your insights sharper',
    saved: 'You saved',
    overspent: 'You spent more than you earned',
    savingsRate: '{{percent}}% savings rate',
    savedVsLastYear: '{{direction}} {{value}} vs last year',
    personalInflation: 'Your personal inflation',
    inflationDesc: 'How your own prices changed this year',
    streakDays: '{{count}} days',
    longestStreak: 'Longest tracking streak',
    outroTitle: "That's your {{year}}!",
    outroDesc: 'Share your year in money',
    hideAmounts: 'Hide amounts',
    share: 'Share',
    shareTitle: '🎁 My {{year}} Wrapped — AI Budget',
    shareSpent: 'Tracked {{value}} in spending',
    shareMerchant: 'Top spot: {{name}} ({{count}} visits)',
    shareMonth: 'Biggest month: {{month}}',
    shareCategory: 'Top category: {{name}} ({{percent}}%)',
    shareReceipts: 'Receipts scanned: {{count}}',
    shareSaved: 'Saved: {{value}}',
    shareInflation: 'My personal inflation: {{percent}}%',
  ...
  communityPrices: {
    ...
    screenTitle: "Where's cheapest",
    entryTitle: "Where's cheapest?",
    entrySubtitle: 'Compare community prices across stores',
    searchPlaceholder: 'Search a product...',
    searchHint: 'Search for a product to compare prices across stores',
    noResults: 'No community prices found for this product yet',
    regionsAvailable: '{{count}} regions',
    cheapest: 'Cheapest',
  ...
  safeToSpend: {
    ...
    subtitle: 'After covering your obligations',
    breakdownTitle: 'How it\'s calculated',
  ...
  priceHistory: {
    ...
    noDataForPeriod: 'Not enough history for this period. Try a shorter range.',
  ...
  shoppingList: {
    title: 'Shopping list',
    settingsSubtitle: 'Plan your shop, find the cheapest store',
    planAShop: 'Plan a shop',
    addItem: 'Add item',
    addFreeText: 'Add "{{text}}"',
    frequentlyBought: 'Frequently bought',
    searchProducts: 'Search products',
    emptyList: 'Add your first item',
    noLists: 'No shopping lists yet',
    createFirstList: 'Create a list',
    clearChecked: 'Clear checked',
    compareCta: 'Compare prices',
    compareTitle: "Where's cheapest",
    comparePaywall: 'Comparing basket prices across stores is a Pro feature.',
    cheapest: 'Cheapest',
    coverage: '{{covered}}/{{total}} items',
    stalePrices: 'Some prices are old',
    missingCount: '{{count}} not priced here',
    cheapestPerItem: 'Cheapest per item',
    notTracked: 'Not tracked yet',
    noPriceData: 'No price history yet — scan a few receipts first',
    comparing: 'Comparing…',
    newList: 'New list',
    ...
    archiveListConfirm: 'Archive this list? It will be hidden but not deleted.',
    listName: 'List name',
    ...
    templates: 'Templates',
    saveAsTemplate: 'Save current list as template',
    templateNamePlaceholder: 'Template name',
    noTemplates: 'No saved templates yet',
    templateItemCount: '{{count}} items',
    templateApplied: 'Template applied',
    templateAllAlreadyOnList: 'Everything from this template is already on your list',
    templateAppliedSomeSkipped: 'Added {{added}}, {{skipped}} already on your list',
  ...
  receiptSplit: {
    ...
    shareByAmount: 'Amount',
    shareReset: 'Split equally',
    shareYou: 'You',
    shareOverAllocated: 'This line is shared out beyond 100%',
    assignEveryone: 'Assign at least one item to everyone',
    assignHint: 'Tap an item, then tap everyone who shared it',
    tapPersonHint: 'Tap everyone who shared this item',
    chipItemCount_one: '{{count}} item',
    chipItemCount_other: '{{count}} items',
