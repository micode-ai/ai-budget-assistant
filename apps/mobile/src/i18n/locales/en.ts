export default {
  ...
  shoppingMode: {
    ...
    arrivalBody: 'Still on your list: {{count}} · Safe to spend today: {{amount}}',
    arrivalBodyNoSpend: 'Still on your list: {{count}}',
    exitTitle: 'You\'re leaving {{merchant}}',
    exitBody: 'Still on your list: {{count}}',
  },
  inflationShield: {
