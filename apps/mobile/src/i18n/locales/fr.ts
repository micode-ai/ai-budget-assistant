export default {
  ...
  shoppingMode: {
    ...
    arrivalBody: 'Encore sur votre liste : {{count}} · Dépense sûre aujourd’hui : {{amount}}',
    arrivalBodyNoSpend: 'Encore sur votre liste : {{count}}',
    exitTitle: 'Vous quittez {{merchant}}',
    exitBody: 'Encore sur votre liste : {{count}}',
  },
  inflationShield: {
