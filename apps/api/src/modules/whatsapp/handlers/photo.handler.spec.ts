...
const userState: WhatsAppUserState = {
  userId: 'user-1',
  accountId: 'acc-1',
  accountRole: 'editor',
  conversationId: null,
  currencyCode: 'PLN',
  language: 'pl',
  waPhoneNumber: '48123456789',
};

function pdfMessage(): WaMediaMessage {
  return {
    from: '48123456789',
    id: 'msg-1',
    timestamp: '0',
...
describe('WhatsApp PhotoHandler — geocoded location wiring (ABA-310 bot photo geocode flag)', () => {
