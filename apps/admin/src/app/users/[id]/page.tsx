...
import { useUserNotificationHistory } from "@/hooks/use-communications";
...
import { ChangeTierDialog } from "@/components/users/ChangeTierDialog";
import { AiLimitCard } from "@/components/users/AiLimitCard";
import { SendPushDialog } from "@/components/users/SendPushDialog";
import { SendEmailDialog } from "@/components/users/SendEmailDialog";
import { DeactivateDeleteDialog } from "@/components/users/DeactivateDeleteDialog";
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <AiLimitCard userId={id} customAiLimit={user.subscription?.customAiLimit} />
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <SendPushDialog userId={id} userName={user.name} disabled={!user.pushToken} />
            <SendEmailDialog userId={id} userName={user.name} />
