...
- **Screens**: `(auth)/` login/register, `(tabs)/` main tabs, `expense/`, `income/`, `budget/`, `account/`, `analytics/`, `calendar/`, `projects/`, `tags/`, `wallet/`, `settings.tsx`, `subscription.tsx`, `admin.tsx`, `story.tsx`
