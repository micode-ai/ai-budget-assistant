# -*- coding: utf-8 -*-
"""
Single "benefit" story (9:16 + 4:5) for the Inflation Shield /
"Tarcza antyinflacyjna" feature: the three hooks (price forecast, where to buy,
zero cost) as bold stat cards on the house-style warm-dark gradient + orange
glow. No phone bezel — the message is the hero. No emoji (text-only so Windows
...
Outputs in docs/marketing/creatives/antinflation/renders/pl/:
    inflation-shield-story.png        1080x1920
    inflation-shield-story-4x5.png    1080x1344

Usage:
    python build_antinflation_story.py          # 9:16
    python build_antinflation_story.py 4:5
    python build_antinflation_story.py both
"""
import os, sys
...
FEATURE_DIR = "antinflation"
BASENAME = "inflation-shield"
...
EYEBROW  = "TARCZA ANTYINFLACYJNA"
HEADLINE = "Kupuj, zanim zdrożeje"
SUBTITLE = "Prognoza cen wprost z Twoich paragonów"
CTA      = "Wyprzedź inflację — kupuj mądrze"
FOOTER_URL = "ai-budget.pl"

# (tag, big value, descriptor)
CARDS = [
    ("PROGNOZA CEN",  "+20%",      "tyle zdrożeje — kup dziś"),
    ("GDZIE KUPIĆ",   "Biedronka", "wskazuje sklep i ilość"),
    ("KOSZT",         "0 zł",      "liczone z Twoich paragonów"),
]
...
def build(aspect):
    ...
    hf = ImageFont.truetype(HEAD_FONT, 76 if is916 else 60)
