# AI Budget Assistant — Guia del usuario
...
1. [Primeros pasos](./01-getting-started.md) — registro, inicio de sesion, primeros pasos
2. [Panel](./02-dashboard.md) — pantalla de inicio y acciones rapidas
3. [Gastos e Ingresos](./03-expenses-and-income.md) — gestion de transacciones
4. [Entrada de voz y Escaneo de recibos](./04-voice-and-receipt.md) — registro de gastos con IA
5. [Presupuestos](./05-budgets.md) — creacion y seguimiento de limites de gasto
6. [Analisis](./06-analytics.md) — graficos, informacion y exploracion de datos
7. [Chat IA](./07-ai-chat.md) — tu asistente financiero personal
8. [Historia de gastos](./08-spending-story.md) — narrativas financieras generadas por IA
9. [Cuentas](./09-accounts.md) — cuentas personales, compartidas y de empresa
